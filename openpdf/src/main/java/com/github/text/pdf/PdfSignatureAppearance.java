...
public class PdfSignatureAppearance {
   ...
   */
  public com.github.text.pdf.PdfName getFilter() {
    return filter;
  }
   ...
   *         signature in the page
   */
  public com.github.text.Rectangle getPageRect() {
    return pageRect;
  }
  ...
  com.github.text.pdf.ByteBuffer getSigout() {
    return sigout;
  }

  void setSigout(com.github.text.pdf.ByteBuffer sigout) {
    this.sigout = sigout;
  }
   ...
   */
  public com.github.text.pdf.PdfDictionary getCryptoDictionary() {
  ...
  public void setCryptoDictionary(
      com.github.text.pdf.PdfDictionary cryptoDictionary) {
   ...
   */
  public com.github.text.pdf.PdfStamper getStamper() {
    return stamper;
  }

  void setStamper(com.github.text.pdf.PdfStamper stamper) {
   ...
   */
  public com.github.text.pdf.PdfSigGenericPKCS getSigStandard() {
    return sigStandard;
  }
