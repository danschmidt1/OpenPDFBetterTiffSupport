...
import com.github.text.PageSize;
import com.github.text.Rectangle;
import com.github.text.error_messages.MessageLocalization;
import com.github.text.exceptions.BadPasswordException;
import com.github.text.exceptions.InvalidPdfException;
import com.github.text.exceptions.UnsupportedPdfException;
...
public class PdfReader implements PdfViewerPreferences {
  ...
  private void readDecryptedDocObj() throws IOException {
    ...
    if (documentIDs != null) {
      ...
      strings.remove(o);
      s = o.toString();
      documentID = com.github.text.DocWriter.getISOBytes(s);
    ...
    if (filter.equals(PdfName.STANDARD)) {
      ...
      uValue = com.github.text.DocWriter.getISOBytes(s);
      s = enc.get(PdfName.O).toString();
      strings.remove(enc.get(PdfName.O));
      oValue = com.github.text.DocWriter.getISOBytes(s);
