...
import com.github.text.pdf.internal.PolylineShape;
...
*/
    ...
    private boolean drawImage(Image img, Image mask, AffineTransform xform, Color bgColor, ImageObserver obs) {
        ...
        try {
            com.github.text.Image image = null;
            if(!convertImagesToJPEG){
                image = com.github.text.Image.getInstance(img, bgColor);
            }
            else{
                ...
                scaled.flush();
                scaled = null;
                image = com.github.text.Image.getInstance(baos.toByteArray());
                
            }
            if (mask!=null) {
                com.github.text.Image msk = com.github.text.Image.getInstance(mask, null, true);
                msk.makeMask();
    ...
    private void setPaint(boolean invert, double xoffset, double yoffset, boolean fill) {
        if (paint instanceof Color) {
            ...
            try {
                ...
                com.github.text.Image image = com.github.text.Image.getInstance(img, null);
